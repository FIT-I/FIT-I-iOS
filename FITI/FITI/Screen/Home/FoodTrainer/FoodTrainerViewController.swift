//
//  FoodTrainerViewController.swift
//  FITI
//
...
class FoodTrainerViewController: UIViewController {
    ...
    func setEmptyImage(){
        if FoodTrainerViewController.trainerList.count > 0 {
...
extension FoodTrainerViewController : UITableViewDelegate {
...
extension FoodTrainerViewController : UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return FoodTrainerViewController.trainerList.count
    }
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.bindingTrainerList(model: FoodTrainerViewController.trainerList[indexPath.row])
...
extension FoodTrainerViewController {
