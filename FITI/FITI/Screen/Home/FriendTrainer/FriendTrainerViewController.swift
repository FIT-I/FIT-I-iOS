//
//  FriendTrainerViewController.swift
//  FITI
//
...
class FriendTrainerViewController: UIViewController {
    ...
    func setEmptyImage(){
        if FriendTrainerViewController.trainerList.count > 0 {
...
extension FriendTrainerViewController : UITableViewDelegate {
...
extension FriendTrainerViewController : UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return FriendTrainerViewController.trainerList.count
    }
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.bindingTrainerList(model: FriendTrainerViewController.trainerList[indexPath.row])
...
extension FriendTrainerViewController {
